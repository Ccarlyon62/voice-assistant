...
source.include_exts = py,png,jpg,kv,atlas,onnx,bin
...
services = VoiceAssistantService:service.py
...
android.permissions = RECORD_AUDIO, FOREGROUND_SERVICE, WAKE_LOCK, POST_NOTIFICATIONS, INTERNET
